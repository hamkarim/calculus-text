...
\secrdef{sec:hyperbolic functions}
\nobreak
...
\defn The other hyperbolic functions are
...
\htmlfigure{Transcendental-HyperbolicTrigs.html}
\htmlonly
\begincaption
...
\thm $\ds{d\over dx}\cosh x=\sinh x$ and 
\endthm
\thmrdef{thm:hyperbolic derivatives}
...
\thm $\ds{d\over dx}\arcsinh x = {1\over\sqrt{1+x^2}}$.
\endthm
\proof
...
\exercise 
\exrdef{exer:hyperbolic double angle formulas}
