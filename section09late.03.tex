...
\endthm
\proof By the Inverse Function Theorem (\xrefn{thm:inverse function
...
\htmlfigure{Transcendental-exp_graph.html}
\begincaption
The graph of $\exp(x)$.
\endcaption
\endfigure
...
\exercise Prove parts (b) and (c) of theorem~\xrefn{thm:exp rules}.
\endexercise
...
\exercise Sketch the graph of $f(x) =3e^{x+6} -4 $.
\endexercise
