...
\htmlfigure{Polar-Parametric-polar_coordinates.html}
\begincaption
...
\example Graph the curve given by $r=1+\cos\theta$. We first consider
...
\htmlfigure{Polar-Parametric-cardioid.html}
\begincaption
...
\htmlfigure{Polar-Parametric-multiple_coordinates.html}
\begincaption
...
\example Graph the polar equation $r=\theta$. Here the distance from
...
\htmlfigure{Polar-Parametric-spiral_of_archimedes.html}
\begincaption
...
\htmlfigure{Polar-Parametric-2_sin.html}
\begincaption
