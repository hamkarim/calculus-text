...
% idxmac.tex
%
% Most of the code in this file is taken from latex.tex and manmac.tex.
% The style of the index environment \beginindex ... \endindex
% can be easily changed according to taste. The current definitions use
% the double column macros of eplain (so eplain must be loaded first).
%
% Modified 16-Nov-1995 to allow user modification of indentation in
% index items. Search for ``idxitemindent''
% 
\def\pagenowrapper#1{#1}
...
\def\@arabic#1{\ifnum #1>0 \number #1\else \romannumeral -#1\fi}
...
\def\@wrindex#1#2{\let\thepage\relax
   \xdef\gtempa{\write#1{\string
      \indexentry{#2|pagenowrapper}{\thepage}}}\endgroup\gtempa
...
\newdimen\@idxitemindent \@idxitemindent40pt
\newdimen\subitemindent \subitemindent20pt
\newdimen\subsubitemindent \subsubitemindent30pt
\def\@idxitem{\par\hangindent \@idxitemindent}
\def\subitem{\par\hangindent \@idxitemindent \hskip \subitemindent}
\def\subsubitem{\par\hangindent \@idxitemindent \hskip \subsubitemindent}
\def\indexspace{\par \vskip 10pt plus 2pt minus 2pt\relax}
