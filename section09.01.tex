...
\htmlfigure{Integration_applications-area_between_curves.html}
\begincaption
...
\htmlfigure{Integration_applications-area_between_curves_rectangles.html}
\begincaption
Approximating area between curves with rectangles.
\endcaption
\endfigure

\example Find the area below $\ds f(x)= -x^2+4x+1$ and above
...
\htmlfigure{Integration_applications-area_between_curves_general.html}
\begincaption
Area between curves.
\endcaption
\endfigure
...
\htmlfigure{Integration_applications-area_between_curves_that_cross.html}
\begincaption
...
\htmlfigure{Integration_applications-area_bounded_by_curves.html}
\begincaption
